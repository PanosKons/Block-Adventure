...
void ScriptingManager::Load()
{
	...
	std::string path = "C:/Users/pkons/OneDrive/Desktop/Projects/Block-Adventure/ScriptCore/bin/Release/net7.0/";
	CoreAssembly = LoadCSharpAssembly(path + "ScriptCore.dll");
